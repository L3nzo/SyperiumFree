...
HudFrame.Position = UDim2.new(0, 100, 0.5, -40)
    ...
    for _, p in pairs(Players:GetPlayers()) do
        ...
        if IsValid(p) and Config.PlayerESP then
            ...
            if vis and dist <= Config.RenderDistance then
                ...
                esp.BoxOutline.Visible = Config.BoxESP
                esp.BoxOutline.Size = esp.Box.Size
                esp.BoxOutline.Position = esp.Box.Position
                
                esp.Name.Visible = Config.NameESP
                esp.Name.Text = "<b>" .. p.Name .. "</b>"
                esp.Name.Position = UDim2.new(0, pos.X - 100, 0, y - 18)
                ...
                if Config.ToolESP then
                    ...
                    esp.Tool.Text = "<b>" .. (tool and tool.Name or "None") .. "</b>"
                    esp.Tool.Position = UDim2.new(0, pos.X - 100, 0, y + h + 8)
                else 
                ...
                if Config.DistanceESP then
                    ...
                    esp.Dist.Text = "<b>" .. math.floor(dist) .. "m</b>"
                    esp.Dist.Position = UDim2.new(0, pos.X - 100, 0, y + h + (Config.ToolESP and 22 or 8))
                else 
                ...
                if Config.HealthBar then
                    ...
                    esp.HealthOutline.Position = Vector2.new(x, y + h + 2)
                    esp.HealthOutline.Size = Vector2.new(w, 4)
                    esp.HealthBar.Position = esp.HealthOutline.Position
                    esp.HealthBar.Size = Vector2.new(w * hpPct, 4)
        ...
        elseif PlayerESPTable[p] then
            for _, obj in pairs(PlayerESPTable[p].Elements) do 
                pcall(function() obj.Visible = false end) 
            end
        end
    end
